...
<span class="red">sidebar: wiki_sidebar</span>
permalink: wiki_alerts
---
</pre>

The `sidebar: wiki_sidebar` refers to the \_data/sidebars/wiki_sidebar.yml file.
...
This would load the `wiki_sidebar` for each file in **pages/wiki**. You could set different defaults for different path scopes.
...
The sidebar data file uses a specific YAML syntax that you must follow. Follow the sample pattern shown in the theme, specically looking at `wiki_sidebar.yml` as an example: Here's a code sample showing all levels:
...
- title: sidebar
  ...
  - title: Release Notes
    ...
    - title: 6.0 Release notes
      url: /wiki_release_notes_60.html
      output: web, pdf

    - title: 5.0 Release notes
      url: /wiki_release_notes_50.html
      output: web, pdf
  ...
  - title: Tag archives
    ...
    - title: Tag archives overview
      url: /wiki_tag_archives_overview.html
      output: web
...
The YAML syntax depends on exact spacing, so make sure you follow the pattern shown in the sample sidebars. See my [YAML tutorial](wiki_yaml_tutorial) for more details about how YAML works.

{% include note.html content="If you have just one character of spacing off, Jekyll won't build due to the YAML syntax error. You'll see an error message in your console that says \"Error ... did not find expected key while parsing a block mapping at line 22 column 5. Error: Run jekyll build --trace for more information.\" If you encounter this, it usually refers to incorrect indentation or spacing in the YAML file. See the example wiki_sidebar.yml file to see where your formatting went wrong." %}
...
- title: sidebar
  ...
  - title: Installation
    ...
    - title: Install Jekyll on Windows
      url: /wiki_install_jekyll_on_windows.html
      output: web, pdf
```
...
For more detail on the sidebar, see [Sidebar navigation] and [YAML tutorial][wiki_yaml_tutorial].
...
For more detail, see [Pages][wiki_pages].

## Where to store your documentation topics

You can store your files for each product inside subfolders following the pattern shown in the theme. For example, discography, product2, etc, can be stored in their own subfolders inside the \_pages directory. Inside \_pages, you can store your topics inside sub-subfolders or sub-sub-folders to your heart's content. When Jekyll builds your site, it will pull the topics into the root directory and use the permalink for the URL.

Note that discography, product2, and wiki are all just sample content to demonstrate how to add multiple products into the theme. You can freely delete that content.

For more information, see [Pages][wiki_pages] and [Posts][wiki_posts].
