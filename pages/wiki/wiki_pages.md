...
I recommend prefixing your page names with the product, such as "wiki_pages" instead of just "pages." This way if you have other products that also have topics with generic names such as "pages," there won't be naming conflicts.
...
For details about linking to headings on different pages, see [Automated links to headings on pages][wiki_hyperlinks.html#bookmarklinks].
