...
permalink: wiki_push_build_to_server.html
folder: wiki
---
...
```
aws s3 cp ~/users/tjohnson/projects/wikiproject/ s3://[aws path]docpath/wikiproject --recursive
...
```
scp -r /users/tjohnson/projects/wikiproject/ name@domain:/var/www/html/wikiproject
```
