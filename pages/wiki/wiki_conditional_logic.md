...
permalink: wiki_conditional_logic.html
folder: wiki
---
...
As such, the conditional logic won't have as much play as it previously did. Instead of conditions, you'll probably want to incorporate [navtabs](wiki_navtabs) to split up the information.
