...
Inside your project's pages directory (e.g., wiki), add a file called "tooltips.json." (You can use whatever name you want.) Add the following to your JSON file:
